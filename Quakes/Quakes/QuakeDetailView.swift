...
class QuakeDetailView: UIView {
    ...
    private func updateSubviews() {
        ...
        latitudeLabel.text = "Lat: " + latLonFormatter
            .string(from: quake.latitude as NSNumber)!
        longitudeLabel.text = "Lon: " + latLonFormatter
            .string(from: quake.longitude as NSNumber)!
    }
}
